        ...
        <div class="container">
            ...
            <div class="student-info">
                ...
                <p>
                    ...
                    <span class="admission">C027-01-0881/2024</span>
                </p>

                <p>
                    <strong>Email:</strong>
                    alvin.mayore24@students.dkut.ac.ke
                </p>
            </div>
            ...
            <p style="color: #7f8c8d; margin-bottom: 20px;">
                Click on any available assignment to view the complete
                code on GitHub.
            </p>
            ...
            <!-- LESSON 3 -->
            <div class="assignment">
                <a href="https://github.com/alvinmayore24-dev/backend"
                   target="_blank">
            ...
            <!-- LESSON 4 -->
            <div class="assignment">
                <a href="https://github.com/alvinmayore24-dev/library-api"
                   target="_blank">
            ...
            <!-- LESSON 5 -->
            <div class="assignment">
                <a href="https://github.com/alvinmayore24-dev/bookstore-api"
                   target="_blank">
            ...
            <!-- LESSON 6 -->
            <div class="assignment">
                <a href="https://github.com/alvinmayore24-dev/product-api.git"
                   target="_blank">
            ...
            <!-- LESSON 7 -->
            <div class="assignment">
                <a href="https://github.com/alvinmayore24-dev/healthtrack-api"
                   target="_blank">
            ...
            <!-- LESSON 8 -->
            <div class="assignment">
                <a href="https://github.com/alvinmayore24-dev/clinical-api"
                   target="_blank">
            ...
            <!-- LESSON 9 -->
            <div class="assignment">
                <a href="https://github.com/alvinmayore24-dev/sendit-api"
                   target="_blank">
